...
public class JalanLavendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jalan_lavendar);
        ...
        communityListAdapter = new CommunityListAdapter(JalanLavendar.this, modelCommunityListArrayList);
    ...
    private void EventChangeListener() {
        ...
        database.collection("community")
                .whereEqualTo("street", "Jalan Lavendar")
