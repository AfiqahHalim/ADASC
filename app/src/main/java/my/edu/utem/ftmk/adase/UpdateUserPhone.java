...
public class UpdateUserPhone extends AppCompatActivity {
        ...
        docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    if (doc.exists())
                    {
                        Log.d("Display phone", "DocumentSnapshot data: " + doc.getData());
                        etUpdatePhone.setText(doc.getData().get("phoneNum").toString());

                    }
                    else {
                        Toast.makeText(getApplicationContext(), "Failed to get your phone number", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
            ...
            nameRef
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UpdateUserPhone.this, "Failed to update.", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
        else {
            Toast.makeText(UpdateUserPhone.this, "This field cannot be blank.", Toast.LENGTH_SHORT).show();
        }
