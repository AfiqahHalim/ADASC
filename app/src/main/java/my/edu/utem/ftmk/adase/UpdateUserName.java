...
public class UpdateUserName extends AppCompatActivity {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    if (doc.exists())
                    {
                        ...
                        etUpdateName.setText(doc.getData().get("fullname").toString());
    ...
    private void updateUsername() {
        ...
        if(!etUpdateName.getText().toString().isEmpty()){
            ...
            nameRef
                    .update("fullname", etUpdateName.getText().toString())
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                           Toast.makeText(UpdateUserName.this, "Failed to update.", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
        else {
            Toast.makeText(UpdateUserName.this, "This field cannot be blank.", Toast.LENGTH_SHORT).show();
        }
