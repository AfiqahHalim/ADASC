...
public class JalanOrkid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jalan_orkid);
        ...
        communityListAdapter = new CommunityListAdapter(JalanOrkid.this, modelCommunityListArrayList);
    ...
    private void EventChangeListener() {
        ...
        database.collection("community")
                .whereEqualTo("street", "Jalan Orkid")
