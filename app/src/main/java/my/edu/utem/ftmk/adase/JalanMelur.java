...
public class JalanMelur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jalan_melur);
        ...
        communityListAdapter = new CommunityListAdapter(JalanMelur.this, modelCommunityListArrayList);
    ...
    private void EventChangeListener() {
        ...
        database.collection("community")
                .whereEqualTo("street", "Jalan Melur")
